...
func GetDefaultPipelineConfigs() []common.Config {
	pipelineConfigs := []common.Config{
		...
		{Name: RetryAttempts, Value: float64(-1)},
		{Name: MemoryLimit, Value: "${jvm:maxMemoryMB() * 0.65}"},
		{Name: MemoryLmtExceeded, Value: "STOP_PIPELINE"},
		{Name: NotifyOnStates, Value: []any{common.RUN_ERROR, common.STOPPED, common.FINISHED}},
		{Name: EmailIds, Value: []any{}},
		{Name: Constants, Value: []any{}},
		...
		{Name: RateLimit, Value: float64(0)},
		{Name: MaxRunners, Value: float64(0)},
